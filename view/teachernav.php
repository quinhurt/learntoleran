...
<nav class="navbar  navbar-expand-lg navbar-dark bg-dark">
  ...
  <ul class="nav nav-pills " id="pills-tab" role="tablist">
    <li class="nav-item">
      <a class="nav-link active" id="pills-home-tab" data-toggle="pill" href="#pills-lesson" role="tab" aria-controls="pills-home" aria-selected="true">update</a>
    </li>
    <li class="nav-item">
    ...
    <li class="nav-item">
      <a class="nav-link" id="pills-contact-tab" data-toggle="pill" href="#pills-new" role="tab" aria-controls="pills-contact" aria-selected="false">assngemnt</a>
    </li>
    <li class="nav-item">
...
<div class="tab-content" id="pills-tabContent">
  <div class="tab-pane fade show active" id="pills-lesson" role="tabpanel" aria-labelledby="pills-home-tab"><?php   include 'html/newlesson.php' ?></div>
